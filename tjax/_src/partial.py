...
class Partial[R]:
    ...
    def tree_unflatten(cls, static: Hashable, trees: Sequence[PyTree]) -> Partial[R]:
        ...
        static_kwargs = dict(static_kwarg_items)  # ty: ignore
        ...
        args = cls._unpartition_args(argument_slots, static_args, dynamic_args)  # ty: ignore
        callable_is_static = argument_slots[0]
        assert isinstance(callable_is_static, bool)
